...
export const initialPanels: Panel[] = [
    {
        ...
        selectedSubmenu: {
            name: "Dashboard",
            slug: "dashboard",
            allowed_permissions: ["ekdak.dpmg.FULL_PERMIT", "ekdak.post-master.FULL_PERMIT", "ekdak.super-admin.FULL_PERMIT"],
            selected: false,
        ...
        submenus: [
            {
                ...
                slug: "dashboard",
                selected: false,
                allowed_permissions: ["ekdak.dpmg.FULL_PERMIT", "brta.brta-master-developer.FULL_PERMIT", "ekdak.super-admin.FULL_PERMIT"],
                icon: "M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z"
            },
            {
                name: "Bookings",
        ...
        submenus: [
            {
                ...
                slug: "dashboard",
                selected: true,
                allowed_permissions: ["ekdak.dpmg.FULL_PERMIT", "ekdak.super-admin.FULL_PERMIT"],
                icon: "M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z"
            },
            {
                name: "SMS",
...

    {
        ...
        submenus: [
            ...
            // },
            {
                ...
                slug: "users",
                selected: false,
                allowed_permissions: ["ekdak.dpmg.FULL_PERMIT", "ekdak.super-admin.FULL_PERMIT", "emts.emts-super-admin.FULL_PERMIT"],
                icon: "M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"
            },
        ]
    },
    {
        ...
        submenus: [
            ...
            // },
            {
                ...
                slug: "users",
                selected: false,
                allowed_permissions: ["ekdak.dpmg.FULL_PERMIT", "ekdak.super-admin.FULL_PERMIT", "dakbazar.dakbazar-super-admin.FULL_PERMIT"],
                icon: "M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"
            },
        ]
    },
