...
const MaterialInput = ({
  ...
  return (
    <div>
      <div className="relative material-textfield w-full text-postDark dark:text-postLight">
        <input
          ref={inputRef}
        ...
        {showClearButton && value.length > 0 && (
          <div className="absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer text-postRed" onClick={clearInput}>
