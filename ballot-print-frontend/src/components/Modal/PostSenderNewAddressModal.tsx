...
export default function PostRecipientNewAddressModal({ isOpen, onClose, lang, addressLocale, commonLocale, validationLocale, post, personType, addressType }: PostRecipientNewAddressModalProps) {
