...
import { UserForgetPasswordData, changePasswordForm } from "@/lib/store/user/types"
import { forget_password } from "@/lib/store/user/actions"
import { useRouter } from "next/navigation"
import { resetPassword } from "@/lib/http/user/resetPassword"



export default function ChangePassForm({ lang, loginLocale, commonLocale, phone }: { lang: Locale, loginLocale: LoginLocale, commonLocale: CommonLocale, phone: string }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            setSuccess(signup_res.message)
            // // console.log(95,signup_res);
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            >
                ...
                <p className="pl-3 text-success text-xl"> {success} </p>
