...
import {RePrintListLocale } from "@/dictionaries/types";
...
const BallotReprintTable = ({
  lang,
  reprintLocale,
}: {
  lang: Locale;
  reprintLocale: RePrintListLocale;
}) => {
      ...
      >
        ...
        <div className="w-full md:w-[49%] lg:w-[49%] xl:w-[49%] 2xl:w-[49%]">
          <Select
            ...
            variant="bordered"
            label={reprintLocale.select_a_period}
            labelPlacement="outside"
            placeholder={reprintLocale.select_a_period}
          ...
          >
            {initialDateTimeRangeOptionsBn.map((option) => (
              <SelectItem key={option.key}>
                {
                  reprintLocale[
                    option.nameKey as keyof typeof reprintLocale
                  ]
                }
              </SelectItem>
            ))}
        ...
        <div className="w-full md:w-[49%] lg:w-[49%] xl:w-[49%] 2xl:w-[49%]">
          <DateRangePicker
            ...
            label={reprintLocale.select_date_range}
            labelPlacement="outside"
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="w-full md:w-[49%]">
            <Input
              size="md"
              aria-label="Search"
              label={reprintLocale.search}
              labelPlacement="outside"
              placeholder={reprintLocale.search_by_serial_no_outbound_or_inbound_address}
              variant="bordered"
        ...
        <div className="w-full grid grid-cols-1 ">
          <div className="flex justify-between items-center mx-2 my-2">
            <span className="text-default-400 text-small">
             {reprintLocale.total} : {lang==="bn"? e_to_b(filteredBallotRecords.length.toString()):filteredBallotRecords.length} {reprintLocale.ballot_records}
            </span>

            <div className="flex justify-center items-center">
              <label className="flex items-center text-default-400 text-small">
              {reprintLocale.rows_per_page} : {" "}
                <select
          ...
          <div className="w-full overflow-x-auto shadow-md dark:bg-gray-900 rounded-md p-1">
            ...
            >
              <TableHeader columns={columns}>
                {(column) => {
                  const tableHeader= reprintLocale[column.name as keyof typeof reprintLocale]||column.name;
                ...
                emptyContent={
                  <div className="text-center py-8">
                    <p className="ss:text-sm xxs:text-sm xs:text-base sm:text-base">
                      {reprintLocale.no_ballot_data_found}
                    </p>
                  </div>
                }
              >
...
export default BallotReprintTable;
