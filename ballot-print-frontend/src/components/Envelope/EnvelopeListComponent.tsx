...
import { BatchListLocale, DashboardLocale, EnvelopeListLocale } from "@/dictionaries/types";
...
const EnvelopeListComponent = ({
    ...
    return (
        <div className="flex-1 flex-col   xxs:p-2 sm:p-3 md:p-4 lg:p-4">
            <div className="mb-4">
                <div className="flex">
                    ...
                    <h2 className="ml-2 text-xl font-semibold mb-4 text-postDark dark:text-postLight">
                        {envelopeListLocale.envelope_records}
                    </h2>
                </div>
            </div>
            ...
            <div className="mt-4">
                <EnvelopeListTable envelopeListLocale={envelopeListLocale} lang={lang} />
            </div>
        </div>
    );
};

export default EnvelopeListComponent;
